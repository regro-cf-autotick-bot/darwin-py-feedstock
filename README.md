...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/darwin-py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12909&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/darwin-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `darwin-py` can be installed with:

```
conda install darwin-py
```

It is possible to list all of the versions of `darwin-py` available on your platform with:
